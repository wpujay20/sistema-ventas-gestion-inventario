		...
		<div id="main">
			...
			<article class="post">
				...
				<body>
                    ...
                    <div class="row">
                        <div class="col-xd-9 col-sm-10 col-md-10">
                        ...
                        <div class="col-xd-9 col-sm-10 col-md-10">
                            <div class="form-group">
                                <label for="dni">Cédula de identificación - DNI</label>
                        ...
                        <div class="col-xd-9 col-sm-10 col-md-10">
                            <div class="form-group">
                                ...
                                {!! Form::text('telefono',null, array('class'=>'form-control','required'=>'required')) !!}
                            </div>
                        </div>
